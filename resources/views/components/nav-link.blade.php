...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-coffee-brown text-sm font-medium leading-5 text-cream focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
